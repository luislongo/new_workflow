...
description: "Analisa mudanças do branch, identifica lacunas de cobertura de testes e gera plano de implementação priorizado"
model: sonnet
---
...
## Saída
Retorne os achados como output desta execução, no formato markdown definido acima. Não escreva em arquivo — o relatório será capturado pelo agente orquestrador. Torne as recomendações específicas, acionáveis, e inclua estruturas de teste de exemplo quando útil. Foque apenas no que mudou no branch atual para manter o escopo gerenciável.
